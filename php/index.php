...
<body>
  ...
  <form action="acceso.php" method=get>
    <fieldset>
      ...
      <a href="http://localhost/listado.php"> Listado de identificadores </a>
    </fieldset>
  </form>
  ...
  <ul>
    ...
    <li>
      Repositorio <a href="https://github.com/germaaan/PRACTICA_02" > PRACTICA_02 </a> con el código de la aplicación.
    </li>
    <li>
